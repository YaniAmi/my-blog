...
import Home from "./pages/Home"; // Mengimpor komponen Home dari file "./pages/Home".
import Profile from "./pages/Profile"; // Mengimpor komponen Profile dari file "./pages/Profile".
import Blog from "./pages/Blog"; // Mengimpor komponen Blog dari file "./pages/Blog".
import Contact from "./pages/Contact"; // Mengimpor komponen Contact dari file "./pages/Contact".
import BlogDetail from "./pages/BlogDetail"; // Mengimpor komponen BlogDetail dari file "./pages/BlogDetail".
import CalkulatorPages from "./pages/Calculator";
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="calculator" element={<CalkulatorPages />} />
      </Routes>
    </div>
  );
}
